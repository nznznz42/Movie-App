        ...
        <div style={{padding: '10px', color: 'white', minHeight: '100vh'}}>
            {loading ? (
                ...
                watchlists.map((watchlist) => (
                    <Paper key={watchlist.name}
                           style={{marginBottom: '10px', padding: '5px', backgroundColor: '#1c1b1b', minWidth: '75vw'}}>
                        ...
                        <Typography>
                            <MovieList movies={watchlist.movies} loading={loading}
                                       onDelete={(movieId) => handleDeleteMovie(watchlist.name, movieId)}
                                       showDelete={true}/>
                        </Typography>
                    </Paper>
                ))
